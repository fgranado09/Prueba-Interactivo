...
const listadoMouses = Productos.filter(obj => obj.tipo == "Mouse");

for (const producto of listadoMouses){
...
const listadoTeclados = Productos.filter(obj => obj.tipo == "Teclado");
...
const listadoMousepads = Productos.filter(obj => obj.tipo == "Mousepad");
